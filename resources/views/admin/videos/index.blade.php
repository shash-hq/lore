...
<div style="background:white; border:1px solid #E5E0D8; border-radius:12px; overflow:hidden;">
    @if($videos->isEmpty())
        <div style="padding:48px 32px; text-align:center;">
            <h2 style="font-family:'Playfair Display',serif; font-size:24px; color:#1A1814; margin:0 0 8px;">No videos yet</h2>
            <p style="font-family:'DM Sans',sans-serif; font-size:14px; color:#6B6560; margin:0 0 20px;">
                Add your first founder story and it will show up in the public catalog immediately.
            </p>
            <a href="{{ route('admin.videos.create') }}"
                style="display:inline-block; background:#D4542A; color:white; padding:10px 20px; border-radius:8px; font-family:'DM Sans',sans-serif; font-size:14px; text-decoration:none;">
                Add Video
            </a>
        </div>
    @else
                            ...
                            <div>
                                ...
                                <div style="margin-top:6px; display:flex; flex-wrap:wrap; gap:6px;">
                                    @foreach($video->categories as $category)
                                        <span style="font-family:'JetBrains Mono',monospace; font-size:10px; background:#F2EFE9; color:#6B6560; border-radius:999px; padding:2px 8px;">
                                            {{ $category->name }}
                                        </span>
                                    @endforeach
                                </div>
                    ...
                    <td style="padding:12px 16px; text-align:center;">
                        <div style="display:flex; justify-content:center; gap:8px;">
                            <a href="{{ route('admin.videos.edit', $video) }}"
                                style="padding:4px 12px; border-radius:6px; border:1px solid #E5E0D8; background:white; color:#1A1814; cursor:pointer; font-family:'DM Sans',sans-serif; font-size:12px; text-decoration:none;">
                                Edit
                            </a>
